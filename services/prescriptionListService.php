...
class ServiceClass
{
    ...
    public function process($search, $page, $itemPerPage)
    {
        ...
        $searchFields = ['name', 'age', 'gender', 'address', 'date'];
        $dynamics = '';
        ...
        $query = "SELECT * FROM prescription WHERE $dynamics ";
        ...
        <button 
            ...
            data-rxid="' . htmlspecialchars($row["rxid"]) . '"
...
<button 
    ...
    data-toggle="modal" 
    data-target="#printPrescriptionModal"
    data-rxid="' . htmlspecialchars($row["rxid"]) . '"
    data-date="' . htmlspecialchars($row["date"]) . '"
    data-name="' . htmlspecialchars($row["name"]) . '"
    data-age="' . htmlspecialchars($row["age"]) . '"
...
>
    <i class="fas fa-file-alt"></i>
         ...
         <button 
            ...
            data-id="' . htmlspecialchars($row["rxid"]) . '"
