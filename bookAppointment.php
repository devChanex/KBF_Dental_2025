...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-12">
                        ...
                        <div class="card-body" id="bodyResult" style="padding-left:20%;padding-right:20%;">
                            ...
                            <button class="btn btn-success" onclick="addBookAppointmentInfo()">Book Appointment</button>
            ...
            <script src="controllers/addBookAppointmentInfo.js"></script>
