...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div class="card shadow mb-12">
                        <div class="card-header py-3 <?php echo $cards; ?>">
                            ...
                            <div class="row float-right" style-"float: right;">
                                Dentist Name:
                                <select id="sdentist" name="sdentist" onchange="getclientdata();">

                                    <option value="Dr. Kathleen B. Factoriza">Dr. Kathleen B. Factoriza</option>
                                    <option value="Dr. Kwin Elizabeth R. Factoriza">Dr. Kwin Elizabeth R. Factoriza</option>
                                    <option value="Dr. Marites San Jose">Dr. Marites San Jose</option>
                                    <option value="Dr. Maria Joan Umaclap">Dr. Maria Joan Umaclap</option>
                                </select>
                                Selected By :
                                ...
                                Date: <input type="date" id="from" onchange="getclientdata();">
                        ...
                        <div class="card-body" id="daterange">
                            <div>
                                <div style=" text-align:left;">
                                    <h2 style="margin:0; font-weight:bold; font-size: 1.5rem;">
                                        <?php echo $systemname; ?>
                                    </h2>
                                    </h2>
                                ...
                                <div style="text-align:center;">
                                    <h2 style="margin:0; font-weight:bold;">DAILY TRANSACTION SUMMARY</h2>
            ...
            <script src="controllers/dailytransactionsummarydentistController.js"></script>
